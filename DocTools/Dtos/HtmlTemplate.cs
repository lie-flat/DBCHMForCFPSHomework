...
namespace DocTools.Dtos
{
    public class HtmlTemplate
    {
        ...
        public HtmlTemplate(DBDto dto, string str_version = "1.0")
        {
            this.DBName = dto.DBName;
            this.Tables = dto.Tables;
        ...
        {
            return System.Reflection.Assembly.GetExecutingAssembly().GetResourceContent("DocTools.TplFile.html.template.html");
        }
